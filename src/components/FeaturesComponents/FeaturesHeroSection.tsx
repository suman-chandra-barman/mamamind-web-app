...
const FeaturesHeroSection = () => {
  return (
    <section className="relative isolate overflow-hidden bg-gradient bg-linear-to-r from-[#2b1b1e] to-[#3e2428] py-20 text-center sm:py-24 md:py-28">
      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center px-4 sm:px-6 lg:px-8">
        <MotionReveal>
          <SectionHeading
            ...
            titleClassName="max-w-4xl text-3xl leading-[1.08] font-bold tracking-tight text-[#f9ecef] sm:text-5xl lg:text-[56px]"
            descriptionClassName="mx-auto mt-6 max-w-2xl text-base leading-8 text-[#cfb0b6] sm:text-lg"
          />
        </MotionReveal>
      </div>
    </section>
